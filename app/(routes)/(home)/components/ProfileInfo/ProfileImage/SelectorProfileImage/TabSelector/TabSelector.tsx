...
export function TabSelector(props: TabSelectorProps) {
  ...
  return (
    <>
      <div className="flex gap-2  justify-between items-center hover:bg-slate-100 
      ...
      >
        <div className="flex gap-2">
          ...
          <div>
            ...
            <span className="text-sm text-gray-600">Choose an image from your divice</span>
          </div>
        </div>
    ...
    p-2 rounded-lg cursor-pointer"
      ...
      >
        <div className="flex gap-2">
          <div className="bg-purple-100 rounded-lg p-2 h-fit">
            <Trash2 className="text-red-800" strokeWidth={1} />
          </div>
          <div>
